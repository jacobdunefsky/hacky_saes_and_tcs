...
class RunnerConfig(ABC):
    ...
    aux_k: int = 0
    aux_k_alpha: float = 1/32

    # high-rank sparsity options
    is_high_rank: bool = False
    high_rank_r: Optional[int] = None
    ...
    # multilayer SAE stuff
    is_multilayer: bool = False
    multilayer_layers: Optional[List[int]] = None
    multilayer_hook_point_str: Optional[str] = None # whatever comes after the period in a hook point like "blocks.5.hook_resid_mid"
